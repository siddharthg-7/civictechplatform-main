...
export function GetStartedButton({ children, className, icon: Icon = ChevronRight, ...props }) {
  return (
    <Button className={cn("group relative overflow-hidden cursor-pointer", className)} size="lg" {...props}>
